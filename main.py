...
from pixel_kart.player import HumanPlayer, RandomAIPlayer
...
if __name__ == "__main__":
    ...
    players = {
        ...
        "pixelkart": {
            "Human": HumanPlayer("Human", Color.BLUE),           # from pixel_kart.player
            "Random AI": RandomAIPlayer("Random AI", Color.RED)
        }
    }
